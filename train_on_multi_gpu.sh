...
CUDA_VISIBLE_DEVICES=0,1,2,3 PORT=8646 \
./tools/dist_train.sh \
    configs/erosive/reppoints_moment_r50_fpn_1x_coco_equalhist.py 4 \
    '--work-dir /data1/qilei_chen/DATA/erosive/work_dirs/reppoints_moment_r50_fpn_1x_coco_equalhist/'
